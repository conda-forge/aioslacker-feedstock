...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/aioslacker-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/aioslacker-feedstock)
...
Once the `conda-forge` channel has been enabled, `aioslacker` can be installed with:

```
conda install aioslacker
```

It is possible to list all of the versions of `aioslacker` available on your platform with:
